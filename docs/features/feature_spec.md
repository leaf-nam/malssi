...
- **오늘·미래**: 오늘 칸은 오늘 도착한 씨앗의 테마색 테두리로 구분한다 (#97, #117).
  씨앗 테마 미확정 시에는 금 테두리 폴백.
...
- 명언 원천 (#123): 번들 `assets/docs/quotes.json` 129件
  (원본 719件 엄선, 한국어 위키인용집, CC BY-SA 4.0 — 정원 탭 하단에 출처 표시).
