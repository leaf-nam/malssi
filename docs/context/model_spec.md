...
- **명언 원천** (#123): `assets/docs/quotes.json` 129件 (원본 `wikiquote.json`
  719件에서 엄선 — 페미니즘 사상 포함 14件 제외 등 카테고리 불일치·단편·
  정보성·극단 제외, 250자 초과는 핵심문장으로 단축,
  한국어 위키인용집, CC BY-SA 4.0 — 정원 탭 하단에 출처 표시).
